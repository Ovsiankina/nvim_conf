...
-- Remap "*P to <C-`> (system cliboard paste)
vim.keymap.set('n', '<C-`>', '"*P', { noremap = true, silent = true})

-- Split nvim with arroy keys
vim.keymap.set('n', '<A-Up>', ':split<CR>', { silent = true })
vim.keymap.set('n', '<A-Down>', ':split<CR>', { silent = true })
vim.keymap.set('n', '<A-Left>', ':vsplit<CR>', { silent = true })
vim.keymap.set('n', '<A-Right>', ':vsplit<CR>', { silent = true })
